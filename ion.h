...
extern "C" {
#endif
  extern void __arrayoperations_MOD_fortran_subgrid_reionization_with_xfrac(fftw_real *nh,fftw_real *ngamma, fftw_real *xfrac,fftw_real *nxion,int *nion,int *len);
#ifdef __cplusplus
#endif
#define ION_H_
#endif
